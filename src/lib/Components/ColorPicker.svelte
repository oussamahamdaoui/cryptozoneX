...
<div class="color-picker" class:open={isOpen} bind:this={element}>
  ...
  <div class="picker">
    <Slider2d bind:valueX={s} bind:valueY={l}>
      <slot slot="bg">
        <div class="gs">
          <div class="bg" style="background-color: {hueC.hex()};" />
          <div class="bg1 bg" />
          <div class="bg2 bg" />
        </div>
      </slot>
    ...
    <div class="wrap">
      <input type="number" bind:value={rgb.r} on:change={update("r")} />
      <input type="number" bind:value={rgb.g} on:change={update("g")} />
      <input type="number" bind:value={rgb.b} on:change={update("b")} />
