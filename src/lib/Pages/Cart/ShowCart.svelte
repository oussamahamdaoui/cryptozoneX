    ...
    <div class="payment-form">
      <RadioGroup selected="free" let:selected let:select>
        <RadioOption value="free" {selected} {select}>
          <span class="no-wrap label">Free delivery</span>
          <span class="lighter no-wrap">10-20 business days</span>
        </RadioOption>
        <RadioOption value="payed" {selected} {select}>
          <span class="no-wrap label">$20 DHL delivery</span>
          <span class="lighter no-wrap">10-20 business days</span>
        </RadioOption>
      </RadioGroup>
      <div class="line" />
      ...
      {:else}
        <button class="primary">Paye $256.54</button>
        <button class="secondary" on:click={() => (showDiscountCode = true)}
